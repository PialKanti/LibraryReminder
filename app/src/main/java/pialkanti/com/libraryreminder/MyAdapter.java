...
import pialkanti.com.libraryreminder.fragment.RemindMeFragment;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    MyAdapter(String Titles[],int Icons[],String Name, int Profile,Context c){ // MyAdapter Constructor with titles and icons parameter
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            UserHomeActivity userHomeActivity = (UserHomeActivity) contxt;
            userHomeActivity.Drawer.closeDrawers();
            ...
            switch (getPosition()) {
                case 1:
                    ...
                    break;
                case 2:
                    Fragment remindMeFragment = new RemindMeFragment();
                    fragmentTransaction.replace(R.id.containerView,remindMeFragment);
                    fragmentTransaction.commit();
                    break;
                case 3:
                    SharedPreferences pref = contxt.getSharedPreferences("MyPref", contxt.MODE_PRIVATE);
                    SharedPreferences.Editor editor = pref.edit();
                    editor.putBoolean("LogIN", false);
                    editor.remove("UserName");
                    editor.commit();
                    dBadapter = new DBadapter(contxt);
                    dBadapter.deleteDatabase();
                    Intent intent = new Intent(contxt,DecideActivity.class);
                    contxt.startActivity(intent);
                    ((UserHomeActivity) contxt).finish();
